...
public class PurpleBlock extends Block{
    ...
    public PurpleBlock(double x, double y){
        super(x,y);
        init(x,y);
        type = BlockType.PURPLE_BLOCK;
    }
    ...
    public void init(double x, double y) { // RedBlock init 내부구현
        ...
        rectangles[3] = new Rectangle2D.Double(x + 2*(BLOCK_WIDTH), y + BLOCK_WIDTH, BLOCK_WIDTH, BLOCK_WIDTH);
    }
}
